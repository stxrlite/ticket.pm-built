...
class ReadyEvent extends structure_1.BaseEvent {
    ...
    async execute() {
        ...
        process.stdout.write(`\x1b[0m🚀  The bot is ready! Logged in as \x1b[37;46;1m${this.client.user?.tag}\x1b[0m (\x1b[37;46;1m${this.client.user?.id}\x1b[0m)
        ...
        const a = await axios_1.default.get("https://raw.githubusercontent.com/Sayrix/sponsors/main/sponsors.json").catch(() => { return; });
        if (a) {
